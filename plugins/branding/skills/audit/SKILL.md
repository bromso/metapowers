...
- If `.branding/` contains only one brand directory, use that automatically
...
1. **Read the brand guidelines:**
   - Read `.branding/<brand>/05-guidelines.md` for the complete brand rules
   - Read `.branding/<brand>/03-verbal.md` for voice and tone details
   - Read `.branding/<brand>/04-visual.md` for visual identity details
...
5. **Write the audit report** to `.branding/<brand>/audit-reports/<date>-<subject>.md` with:
...
The audit report written to `.branding/<brand>/audit-reports/`. Present a summary to the user highlighting:
