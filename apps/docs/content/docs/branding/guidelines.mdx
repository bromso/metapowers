...
Requires all prior phase artifacts, especially `.branding/<brand>/04-visual.md`. Use `--skip-checks` to bypass.
...
4. References all assets in `.branding/<brand>/assets/`
5. Writes the guidelines to `.branding/<brand>/05-guidelines.md`

## Output

Creates `.branding/<brand>/05-guidelines.md` containing:
