...
Requires `.accessibility/<target>/03-report.md` from the Report phase. Use `--skip-checks` to bypass.
...
6. Writes the log to `.accessibility/<target>/04-remediate.md`

## Output

Creates `.accessibility/<target>/04-remediate.md` containing:
