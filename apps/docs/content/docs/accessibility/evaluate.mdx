...
Requires `.accessibility/<target>/01-scope.md` from the Scope phase. Use `--skip-checks` to bypass.
...
5. Writes results to `.accessibility/<target>/02-evaluate.md`

## Output

Creates `.accessibility/<target>/02-evaluate.md` containing:
