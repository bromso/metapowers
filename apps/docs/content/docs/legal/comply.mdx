...
**Output:** GDPR compliance plan with implementation checklist → `.legal/<topic>/03-comply.md`
...
**Output:** CCPA compliance plan with consumer rights workflows → `.legal/<topic>/03-comply.md`
...
**Output:** DPA document with processing details and security measures → `.legal/<topic>/03-comply.md`
...
**Output:** Cookie consent implementation plan with UX specifications → `.legal/<topic>/03-comply.md`
...
**Output:** Accessibility compliance plan with WCAG mapping → `.legal/<topic>/03-comply.md`
...
**Output:** SOC 2 readiness assessment with control mapping → `.legal/<topic>/03-comply.md`
...
**Output:** Incident response plan with notification workflows → `.legal/<topic>/03-comply.md`
